...
#define KS_ERR_DEVICE_NOT_SHARED    (0x21)    /*device not shared*/
#define KS_DEVICE_OPEN_NO_ERR       (0x22)
#define KS_DEVICE_WRITE_NO_ERR      (0x23)
#define KS_DEVICE_WRITE_ERR         (0x24)
#define KS_DEVICE_READ_ERR          (0x25)
#define KS_DEVICE_READ_NO_ERR       (0x26)
#define KS_DEVICE_IOCTL_ERR         (0x27)
#define KS_DEVICE_IOCTL_NO_ERR      (0X28)
#define KS_DEVICE_CLOSE_ERR         (0x29)
#define KS_DEVICE_CLOSE_NO_ERR      (0X30)
#endif