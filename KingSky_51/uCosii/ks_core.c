...
static void ks_idle_init(void) reentrant;
static void ks_variable_init(void)  ;
/*定义空闲线程的栈空间,类型为KS_STACK*/
KS_STACK thread_stack_idle[99+1];
/*
 *********************************************************************************************************
...
static void ks_item_init(ks_list_item *item) reentrant    /*双向链表节点的初始化			*/
{
 ...
 *********************************************************************************************************
 */
void ks_item_remove( ks_list_item *list_item ) reentrant
{
	ks_list * list;
...
void ks_schedule(void)	reentrant
{
#if KS_CRITICAL_METHOD == 3
	KS_CPU_SR cpu_sr;
#endif
...
void ks_time_tick(void) reentrant
{
#if KS_CRITICAL_METHOD == 3
	KS_CPU_SR cpu_sr;
#endif
...
void ks_int_exit(void) reentrant                /*中断离开*/
{
#if KS_CRITICAL_METHOD == 3
	KS_CPU_SR cpu_sr;
#endif
