...
KS_EXT TIMER Timer_Tcb[MAX_TIMER];
...
KS_EXT void ks_timer_init(void);
KS_EXT TIMER * ks_timer_create(void (*p)());
KS_EXT void ks_timer_remove(TIMER *ptr);
KS_EXT void ks_timer_start(TIMER *ptr,uint32 time);
KS_EXT void ks_timer_stop(TIMER *ptr);
KS_EXT uint32 ks_timer_lef_get(TIMER *ptr);
KS_EXT void ks_timer_restart(TIMER *ptr,uint32 time);
KS_EXT void ks_timer_tick(void);
#endif
